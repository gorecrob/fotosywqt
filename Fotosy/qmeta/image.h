...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>include/qmeta/image.h at master from ollix's qmeta - GitHub</title>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d">qmeta</a></b> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include">include</a> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta">qmeta</a> / image.h       <span style="display:none" id="clippy_3934">include/qmeta/image.h</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3934&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets1.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3934&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
      ...
      <div class="file">
        <div class="meta">
          ...
          <ul class="actions">
              ...
              <li><a id="file-edit-link" href="#" rel="/ollix/qmeta/file-edit/__ref__/include/qmeta/image.h">edit</a></li>
            
            <li><a href="/ollix/qmeta/raw/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/image.h" id="raw-url">raw</a></li>
            
              <li><a href="/ollix/qmeta/blame/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/image.h">blame</a></li>
            
            <li><a href="/ollix/qmeta/commits/master/include/qmeta/image.h">history</a></li>
          </ul>
        </div>
...
<span id="LID60" rel="#L60">60</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">// Copyright 2010, Ollix</span></div><div class='line' id='LC2'><span class="c1">// All rights reserved.</span></div><div class='line' id='LC3'><span class="c1">//</span></div><div class='line' id='LC4'><span class="c1">// This file is part of QMeta.</span></div><div class='line' id='LC5'><span class="c1">//</span></div><div class='line' id='LC6'><span class="c1">// QMeta is free software: you can redistribute it and/or modify it under</span></div><div class='line' id='LC7'><span class="c1">// the terms of the GNU General Public License as published by the Free</span></div><div class='line' id='LC8'><span class="c1">// Software Foundation, either version 3 of the License, or any later version.</span></div><div class='line' id='LC9'><span class="c1">//</span></div><div class='line' id='LC10'><span class="c1">// QMeta is distributed in the hope that it will be useful, but WITHOUT</span></div><div class='line' id='LC11'><span class="c1">// ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or</span></div><div class='line' id='LC12'><span class="c1">// FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License</span></div><div class='line' id='LC13'><span class="c1">// for more details.</span></div><div class='line' id='LC14'><span class="c1">//</span></div><div class='line' id='LC15'><span class="c1">// You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC16'><span class="c1">// along with QMeta. If not, see &lt;http://www.gnu.org/licenses/&gt;.</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="c1">// ---</span></div><div class='line' id='LC19'><span class="c1">// Author: olliwang@ollix.com (Olli Wang)</span></div><div class='line' id='LC20'><span class="c1">//</span></div><div class='line' id='LC21'><span class="c1">// QMeta - a library to manipulate image metadata based on Qt.</span></div><div class='line' id='LC22'><span class="c1">//</span></div><div class='line' id='LC23'><span class="c1">// This file defines the Image class, which has the ability to guess the file</span></div><div class='line' id='LC24'><span class="c1">// type of the specified image data, and can be used as a normal file class</span></div><div class='line' id='LC25'><span class="c1">// such as Jpeg, Tiff, etc.</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="cp">#ifndef QMETA_IMAGE_H_</span></div><div class='line' id='LC28'><span class="cp">#define QMETA_IMAGE_H_</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'><span class="cp">#include &quot;qmeta/exif.h&quot;</span></div><div class='line' id='LC31'><span class="cp">#include &quot;qmeta/file.h&quot;</span></div><div class='line' id='LC32'><span class="cp">#include &quot;qmeta/identifiers.h&quot;</span></div><div class='line' id='LC33'><span class="cp">#include &quot;qmeta/iptc.h&quot;</span></div><div class='line' id='LC34'><span class="cp">#include &quot;qmeta/jpeg.h&quot;</span></div><div class='line' id='LC35'><span class="cp">#include &quot;qmeta/tiff.h&quot;</span></div><div class='line' id='LC36'><span class="cp">#include &quot;qmeta/xmp.h&quot;</span></div><div class='line' id='LC37'><br/></div><div class='line' id='LC38'><span class="n">namespace</span> <span class="n">qmeta</span> <span class="p">{</span></div><div class='line' id='LC39'><br/></div><div class='line' id='LC40'><span class="n">class</span> <span class="n">Image</span> <span class="o">:</span> <span class="n">public</span> <span class="n">File</span> <span class="p">{</span></div><div class='line' id='LC41'><span class="nl">public:</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Image</span><span class="p">(</span><span class="n">QByteArray</span> <span class="o">*</span><span class="n">data</span><span class="p">);</span></div><div class='line' id='LC43'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Image</span><span class="p">(</span><span class="n">QIODevice</span> <span class="o">*</span><span class="n">file</span><span class="p">);</span></div><div class='line' id='LC44'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Image</span><span class="p">(</span><span class="k">const</span> <span class="n">QString</span> <span class="o">&amp;</span><span class="n">file_name</span><span class="p">);</span></div><div class='line' id='LC45'>&nbsp;&nbsp;<span class="n">bool</span> <span class="n">IsValid</span><span class="p">();</span></div><div class='line' id='LC46'><br/></div><div class='line' id='LC47'>&nbsp;&nbsp;<span class="n">FileType</span> <span class="n">file_type</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">file_type_</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC48'><br/></div><div class='line' id='LC49'>&nbsp;<span class="nl">private:</span></div><div class='line' id='LC50'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">GuessType</span><span class="p">();</span></div><div class='line' id='LC51'>&nbsp;&nbsp;<span class="n">template</span><span class="o">&lt;</span><span class="n">class</span> <span class="n">T</span><span class="o">&gt;</span> <span class="n">bool</span> <span class="n">GuessType</span><span class="p">(</span><span class="n">FileType</span> <span class="n">file_type</span><span class="p">);</span></div><div class='line' id='LC52'><br/></div><div class='line' id='LC53'>&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">set_file_type</span><span class="p">(</span><span class="n">FileType</span> <span class="n">file_type</span><span class="p">)</span> <span class="p">{</span> <span class="n">file_type_</span> <span class="o">=</span> <span class="n">file_type</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC54'>&nbsp;&nbsp;<span class="n">FileType</span> <span class="n">file_type_</span><span class="p">;</span></div><div class='line' id='LC55'><span class="p">};</span></div><div class='line' id='LC56'><br/></div><div class='line' id='LC57'><span class="p">}</span>  <span class="c1">// namespace qmeta</span></div><div class='line' id='LC58'><br/></div><div class='line' id='LC59'><span class="cp">#endif  </span><span class="c1">// QMETA_IMAGE_H_</span></div><div class='line' id='LC60'><br/></div></pre></div>
      ...
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.05363s from fe2.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
