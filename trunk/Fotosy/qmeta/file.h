...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>include/qmeta/file.h at master from ollix's qmeta - GitHub</title>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d">qmeta</a></b> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include">include</a> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta">qmeta</a> / file.h       <span style="display:none" id="clippy_3591">include/qmeta/file.h</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3591&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets1.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3591&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
        ...
        <div class="meta">
          <div class="info">
            ...
            <span class="mode" title="File Mode">100644</span>
              ...
              <span>85 lines (69 sloc)</span>
            
            <span>2.459 kb</span>
          </div>
          <ul class="actions">
            
              <li><a id="file-edit-link" href="#" rel="/ollix/qmeta/file-edit/__ref__/include/qmeta/file.h">edit</a></li>
            
            <li><a href="/ollix/qmeta/raw/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/file.h" id="raw-url">raw</a></li>
            
              <li><a href="/ollix/qmeta/blame/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/file.h">blame</a></li>
            
            <li><a href="/ollix/qmeta/commits/master/include/qmeta/file.h">history</a></li>
          </ul>
        </div>
...
<span id="LID85" rel="#L85">85</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">// Copyright 2010, Ollix</span></div><div class='line' id='LC2'><span class="c1">// All rights reserved.</span></div><div class='line' id='LC3'><span class="c1">//</span></div><div class='line' id='LC4'><span class="c1">// This file is part of QMeta.</span></div><div class='line' id='LC5'><span class="c1">//</span></div><div class='line' id='LC6'><span class="c1">// QMeta is free software: you can redistribute it and/or modify it under</span></div><div class='line' id='LC7'><span class="c1">// the terms of the GNU General Public License as published by the Free</span></div><div class='line' id='LC8'><span class="c1">// Software Foundation, either version 3 of the License, or any later version.</span></div><div class='line' id='LC9'><span class="c1">//</span></div><div class='line' id='LC10'><span class="c1">// QMeta is distributed in the hope that it will be useful, but WITHOUT</span></div><div class='line' id='LC11'><span class="c1">// ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or</span></div><div class='line' id='LC12'><span class="c1">// FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License</span></div><div class='line' id='LC13'><span class="c1">// for more details.</span></div><div class='line' id='LC14'><span class="c1">//</span></div><div class='line' id='LC15'><span class="c1">// You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC16'><span class="c1">// along with QMeta. If not, see &lt;http://www.gnu.org/licenses/&gt;.</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="c1">// ---</span></div><div class='line' id='LC19'><span class="c1">// Author: olliwang@ollix.com (Olli Wang)</span></div><div class='line' id='LC20'><span class="c1">//</span></div><div class='line' id='LC21'><span class="c1">// QMeta - a library to manipulate image metadata based on Qt.</span></div><div class='line' id='LC22'><span class="c1">//</span></div><div class='line' id='LC23'><span class="c1">// This file defines the File class which is the base class for all QMeta</span></div><div class='line' id='LC24'><span class="c1">// supported file types.</span></div><div class='line' id='LC25'><br/></div><div class='line' id='LC26'><span class="cp">#ifndef QMETA_FILE_H_</span></div><div class='line' id='LC27'><span class="cp">#define QMETA_FILE_H_</span></div><div class='line' id='LC28'><br/></div><div class='line' id='LC29'><span class="cp">#include &lt;QObject&gt;</span></div><div class='line' id='LC30'><br/></div><div class='line' id='LC31'><span class="n">class</span> <span class="n">QIODevice</span><span class="p">;</span></div><div class='line' id='LC32'><br/></div><div class='line' id='LC33'><span class="n">namespace</span> <span class="n">qmeta</span> <span class="p">{</span></div><div class='line' id='LC34'><br/></div><div class='line' id='LC35'><span class="n">class</span> <span class="n">Exif</span><span class="p">;</span></div><div class='line' id='LC36'><span class="n">class</span> <span class="n">Iptc</span><span class="p">;</span></div><div class='line' id='LC37'><span class="n">class</span> <span class="n">Xmp</span><span class="p">;</span></div><div class='line' id='LC38'><br/></div><div class='line' id='LC39'><span class="n">class</span> <span class="n">File</span> <span class="o">:</span> <span class="n">public</span> <span class="n">QObject</span> <span class="p">{</span></div><div class='line' id='LC40'>&nbsp;<span class="nl">public:</span></div><div class='line' id='LC41'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">File</span><span class="p">(</span><span class="n">QByteArray</span> <span class="o">*</span><span class="n">data</span><span class="p">);</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">File</span><span class="p">(</span><span class="n">QIODevice</span> <span class="o">*</span><span class="n">file</span><span class="p">);</span></div><div class='line' id='LC43'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">File</span><span class="p">(</span><span class="k">const</span> <span class="n">QString</span> <span class="o">&amp;</span><span class="n">file_name</span><span class="p">);</span></div><div class='line' id='LC44'>&nbsp;&nbsp;<span class="n">QByteArray</span> <span class="n">Thumbnail</span><span class="p">();</span></div><div class='line' id='LC45'><br/></div><div class='line' id='LC46'>&nbsp;&nbsp;<span class="n">Exif</span><span class="o">*</span> <span class="n">exif</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">exif_</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC47'>&nbsp;&nbsp;<span class="n">Iptc</span><span class="o">*</span> <span class="n">iptc</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">iptc_</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC48'>&nbsp;&nbsp;<span class="n">Xmp</span><span class="o">*</span> <span class="n">xmp</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">xmp_</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC49'><br/></div><div class='line' id='LC50'>&nbsp;<span class="nl">protected:</span></div><div class='line' id='LC51'>&nbsp;&nbsp;<span class="c1">// Initializes the Exif object.</span></div><div class='line' id='LC52'>&nbsp;&nbsp;<span class="k">virtual</span> <span class="kt">void</span> <span class="n">InitExif</span><span class="p">()</span> <span class="p">{};</span></div><div class='line' id='LC53'>&nbsp;&nbsp;<span class="k">virtual</span> <span class="kt">void</span> <span class="nf">InitIptc</span><span class="p">()</span> <span class="p">{};</span></div><div class='line' id='LC54'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">InitMetadata</span><span class="p">();</span></div><div class='line' id='LC55'>&nbsp;&nbsp;<span class="k">virtual</span> <span class="kt">void</span> <span class="nf">InitXmp</span><span class="p">()</span> <span class="p">{};</span></div><div class='line' id='LC56'><br/></div><div class='line' id='LC57'>&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">set_exif</span><span class="p">(</span><span class="n">Exif</span> <span class="o">*</span><span class="n">exif</span><span class="p">)</span> <span class="p">{</span> <span class="n">exif_</span> <span class="o">=</span> <span class="n">exif</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC58'>&nbsp;&nbsp;<span class="n">QIODevice</span><span class="o">*</span> <span class="n">file</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">file_</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC59'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">set_iptc</span><span class="p">(</span><span class="n">Iptc</span> <span class="o">*</span><span class="n">iptc</span><span class="p">)</span> <span class="p">{</span> <span class="n">iptc_</span> <span class="o">=</span> <span class="n">iptc</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC60'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">set_xmp</span><span class="p">(</span><span class="n">Xmp</span> <span class="o">*</span><span class="n">xmp</span><span class="p">)</span> <span class="p">{</span> <span class="n">xmp_</span> <span class="o">=</span> <span class="n">xmp</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC61'><br/></div><div class='line' id='LC62'>&nbsp;<span class="nl">private:</span></div><div class='line' id='LC63'>&nbsp;&nbsp;<span class="c1">// Returns true if the tracked file is valid. This function should be</span></div><div class='line' id='LC64'>&nbsp;&nbsp;<span class="c1">// reimplemented in all subclasses to verify specific file types.</span></div><div class='line' id='LC65'>&nbsp;&nbsp;<span class="k">virtual</span> <span class="n">bool</span> <span class="n">IsValid</span><span class="p">()</span> <span class="p">{</span> <span class="k">return</span> <span class="nb">false</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC66'><br/></div><div class='line' id='LC67'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">set_file</span><span class="p">(</span><span class="n">QIODevice</span> <span class="o">*</span><span class="n">file</span><span class="p">)</span> <span class="p">{</span> <span class="n">file_</span> <span class="o">=</span> <span class="n">file</span><span class="p">;</span> <span class="p">}</span></div><div class='line' id='LC68'><br/></div><div class='line' id='LC69'>&nbsp;&nbsp;<span class="c1">// The corresponded Exif object of the tracked file. This property is set</span></div><div class='line' id='LC70'>&nbsp;&nbsp;<span class="c1">// if the tracked file supports the EXIF standard.</span></div><div class='line' id='LC71'>&nbsp;&nbsp;<span class="n">Exif</span> <span class="o">*</span><span class="n">exif_</span><span class="p">;</span></div><div class='line' id='LC72'>&nbsp;&nbsp;<span class="c1">// Tracks the current opened file.</span></div><div class='line' id='LC73'>&nbsp;&nbsp;<span class="n">QIODevice</span> <span class="o">*</span><span class="n">file_</span><span class="p">;</span></div><div class='line' id='LC74'>&nbsp;&nbsp;<span class="c1">// The corresponded Iptc object of the tracked file. This property is set</span></div><div class='line' id='LC75'>&nbsp;&nbsp;<span class="c1">// if the tracked file supports the IPTC standard.</span></div><div class='line' id='LC76'>&nbsp;&nbsp;<span class="n">Iptc</span> <span class="o">*</span><span class="n">iptc_</span><span class="p">;</span></div><div class='line' id='LC77'>&nbsp;&nbsp;<span class="c1">// The corresponded Xmp object of the tracked file. This property is set</span></div><div class='line' id='LC78'>&nbsp;&nbsp;<span class="c1">// if the tracked file supports the XMP standard.</span></div><div class='line' id='LC79'>&nbsp;&nbsp;<span class="n">Xmp</span> <span class="o">*</span><span class="n">xmp_</span><span class="p">;</span></div><div class='line' id='LC80'><span class="p">};</span></div><div class='line' id='LC81'><br/></div><div class='line' id='LC82'><span class="p">}</span>  <span class="c1">// namespace qmeta</span></div><div class='line' id='LC83'><br/></div><div class='line' id='LC84'><span class="cp">#endif  </span><span class="c1">// QMETA_FILE_H_</span></div><div class='line' id='LC85'><br/></div></pre></div>
