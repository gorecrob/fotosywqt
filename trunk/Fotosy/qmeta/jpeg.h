...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>include/qmeta/jpeg.h at master from ollix's qmeta - GitHub</title>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d">qmeta</a></b> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include">include</a> / <a href="/ollix/qmeta/tree/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta">qmeta</a> / jpeg.h       <span style="display:none" id="clippy_3316">include/qmeta/jpeg.h</span>
      ...
      <div class="file">
        <div class="meta">
          ...
          <ul class="actions">
              ...
              <li><a id="file-edit-link" href="#" rel="/ollix/qmeta/file-edit/__ref__/include/qmeta/jpeg.h">edit</a></li>
            
            <li><a href="/ollix/qmeta/raw/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/jpeg.h" id="raw-url">raw</a></li>
            
              <li><a href="/ollix/qmeta/blame/822a8181d24165ad0c110b5d466065a80fcc7a0d/include/qmeta/jpeg.h">blame</a></li>
            
            <li><a href="/ollix/qmeta/commits/master/include/qmeta/jpeg.h">history</a></li>
          </ul>
        </div>
...
<span id="LID50" rel="#L50">50</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">// Copyright 2010, Ollix</span></div><div class='line' id='LC2'><span class="c1">// All rights reserved.</span></div><div class='line' id='LC3'><span class="c1">//</span></div><div class='line' id='LC4'><span class="c1">// This file is part of QMeta.</span></div><div class='line' id='LC5'><span class="c1">//</span></div><div class='line' id='LC6'><span class="c1">// QMeta is free software: you can redistribute it and/or modify it under</span></div><div class='line' id='LC7'><span class="c1">// the terms of the GNU General Public License as published by the Free</span></div><div class='line' id='LC8'><span class="c1">// Software Foundation, either version 3 of the License, or any later version.</span></div><div class='line' id='LC9'><span class="c1">//</span></div><div class='line' id='LC10'><span class="c1">// QMeta is distributed in the hope that it will be useful, but WITHOUT</span></div><div class='line' id='LC11'><span class="c1">// ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or</span></div><div class='line' id='LC12'><span class="c1">// FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License</span></div><div class='line' id='LC13'><span class="c1">// for more details.</span></div><div class='line' id='LC14'><span class="c1">//</span></div><div class='line' id='LC15'><span class="c1">// You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC16'><span class="c1">// along with QMeta. If not, see &lt;http://www.gnu.org/licenses/&gt;.</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="c1">// ---</span></div><div class='line' id='LC19'><span class="c1">// Author: olliwang@ollix.com (Olli Wang)</span></div><div class='line' id='LC20'><span class="c1">//</span></div><div class='line' id='LC21'><span class="c1">// QMeta - a library to manipulate image metadata based on Qt.</span></div><div class='line' id='LC22'><span class="c1">//</span></div><div class='line' id='LC23'><span class="c1">// This file defines the Jpeg class.</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'><span class="cp">#ifndef QMETA_JPEG_</span></div><div class='line' id='LC26'><span class="cp">#define QMETA_JPEG_</span></div><div class='line' id='LC27'><br/></div><div class='line' id='LC28'><span class="cp">#include &quot;qmeta/file.h&quot;</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'><span class="n">class</span> <span class="n">QString</span><span class="p">;</span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'><span class="n">namespace</span> <span class="n">qmeta</span> <span class="p">{</span></div><div class='line' id='LC33'><br/></div><div class='line' id='LC34'><span class="n">class</span> <span class="n">Jpeg</span> <span class="o">:</span> <span class="n">public</span> <span class="n">File</span> <span class="p">{</span></div><div class='line' id='LC35'>&nbsp;<span class="nl">public:</span></div><div class='line' id='LC36'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Jpeg</span><span class="p">(</span><span class="n">QByteArray</span> <span class="o">*</span><span class="n">data</span><span class="p">);</span></div><div class='line' id='LC37'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Jpeg</span><span class="p">(</span><span class="n">QIODevice</span> <span class="o">*</span><span class="n">file</span><span class="p">);</span></div><div class='line' id='LC38'>&nbsp;&nbsp;<span class="n">explicit</span> <span class="n">Jpeg</span><span class="p">(</span><span class="k">const</span> <span class="n">QString</span> <span class="o">&amp;</span><span class="n">file_name</span><span class="p">);</span></div><div class='line' id='LC39'>&nbsp;&nbsp;<span class="n">bool</span> <span class="n">IsValid</span><span class="p">();</span></div><div class='line' id='LC40'><br/></div><div class='line' id='LC41'>&nbsp;<span class="nl">private:</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">InitExif</span><span class="p">();</span></div><div class='line' id='LC43'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">InitIptc</span><span class="p">();</span></div><div class='line' id='LC44'>&nbsp;&nbsp;<span class="kt">void</span> <span class="n">InitXmp</span><span class="p">();</span></div><div class='line' id='LC45'><span class="p">};</span></div><div class='line' id='LC46'><br/></div><div class='line' id='LC47'><span class="p">}</span>  <span class="c1">// namespace qmeta</span></div><div class='line' id='LC48'><br/></div><div class='line' id='LC49'><span class="cp">#endif  </span><span class="c1">// QMETA_JPEG_</span></div><div class='line' id='LC50'><br/></div></pre></div>
      ...
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.05727s from fe2.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
